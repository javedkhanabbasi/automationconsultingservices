          ...
          <div className="container-x py-20 lg:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <p className="text-lg lg:text-xl text-white/80 leading-relaxed max-w-3xl">
                Automation Consulting Services builds operations infrastructure for $1M-$10M operators. Founded in late 2024 by Matthew Piwko. Run by people who treat your back office the way they would treat production software.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-8">
                ...
                <div className="space-y-5 text-ink-70 leading-relaxed">
                  ...
                  <p className="text-black font-semibold">The thesis is simple. Treat your operations the way you would treat your software, because at $1M-$10M, your operations is your software.</p>
                </div>
              </div>
            </div>
          </div>
