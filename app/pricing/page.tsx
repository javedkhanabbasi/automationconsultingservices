...
const comparison = [
  { option: 'ACS mid-tier build', cost: '$15K – $50K', timeline: '4-8 weeks', delivers: ['3-8 production workflows', 'CRM data model design', 'Custom integrations included', 'Runbook and training', '60 days of tuning'], risks: 'Scope locked at end of discovery. Change orders are explicit.', featured: true },
  { option: 'In-house automation engineer', cost: '$120K – $180K/yr', timeline: '3-6 months to productivity', delivers: ['Continuous in-house capacity', 'Direct on-call coverage', 'Deep institutional knowledge'], risks: 'Hard to hire at $1M-$10M scale. Single point of failure. Workflows stay in their head.', featured: false },
        ...
        <section className="bg-white section-padding">
          <div className="container-x">
            <div className="max-w-3xl mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-black leading-tight mb-4">
                What a $15K-$50K mid-tier build actually buys.
              </h2>
              <p className="text-ink-70 leading-relaxed">
                  ...
                  <div className={`px-7 py-5 ${c.featured ? 'bg-black text-white' : 'bg-white text-black'}`}>
                    ...
                    {c.featured && (
                      <div className="mt-3 inline-flex items-center gap-1.5 bg-lime text-black px-2.5 py-1 rounded text-[11px] font-bold">
                        ✓ Recommended for $1M-$10M operators
                      </div>
                    )}
                  </div>
