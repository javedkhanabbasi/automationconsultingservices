...
export const crmPlatforms: CrmPlatform[] = [
  ...
  },
  {
    ...
    practitionerNote:
      'Salesforce is overkill for most $1M-$10M operators. The platform is excellent at what it does, but you pay for capability you will not use until $25M+.',
    capabilities: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '12-24 weeks for $1M-$10M operators. Longer if extensive custom objects or compliance requirements are involved.',
      },
    ],
  },
  {
